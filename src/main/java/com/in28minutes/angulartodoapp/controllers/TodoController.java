...
import com.in28minutes.angulartodoapp.todo.TodoRepository;
...
public class TodoController {
	...
	public ResponseEntity<Todo> addTodo(@PathVariable String username, @RequestBody Todo todo) {
		Todo newTodo = todoRepository.addNewTodo(username, todo.getDescription(), todo.getTargetDate(), todo.isDone());
